...
public class BoundBooster : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        // 反射後の速度に加速を加える
        if (isset) rb.linearVelocity = value * reflectedVelocity.normalized;
        else rb.linearVelocity = boostMultiplier * rb.linearVelocity.magnitude * reflectedVelocity.normalized;
    }
}
